    ...
    describe("powerUpgrade", () => {
        ...
        `("should successfully apply power upgrade $upgradeIndex",
            ({ upgradeIndex, expectedCost, expectedPowerIncrease, expectedUpgradeIndex }) => {
                ...
                expect(mockResourceManager.changeEuros).toHaveBeenCalledWith(-expectedCost);
                expect(mockResourceManager.addClickPower).toHaveBeenCalledWith(expectedPowerIncrease);
    ...
    describe("multUpgrade", () => {
        ...
        `("should successfully apply multiplier upgrade $upgradeIndex",
            ({ upgradeIndex, expectedMultiplier, expectedUpgradeIndex, prereqIndex }) => {
                ...
                expect(result).toBe(true);
                expect(mockResourceManager.setMultiplier).toHaveBeenCalledWith(expectedMultiplier);
    ...
    describe("save/load data", () => {
        it("should correctly save and load data", () => {
            const mockData = {
                ...
                companyUpgrades: {
                    reward: false, size: false, speed: true, biggerProjects: false,
                    reward2: false, size2: false, speed2: false, biggerProjects2: false,
                    reward3: false, size3: false, speed3: false, biggerProjects3: false,
                },
            };
