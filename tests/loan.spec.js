...
test('taking out and paying off a loan with 0 prestige', async ({ context, page }) => {
...
test('taking out and paying off a loan with 2 prestige', async ({ context, page }) => {
  await setSaveData(context, "ResourceManagerData", { euro: 999.99, prestige: 2 });
  await page.goto('http://localhost:5173/EngineerClicker/');
...
test('taking out and paying off a loan with 5 prestige', async ({ context, page }) => {
  await setSaveData(context, "ResourceManagerData", { euro: 7499.99, prestige: 5 });
  await page.goto('http://localhost:5173/EngineerClicker/');
